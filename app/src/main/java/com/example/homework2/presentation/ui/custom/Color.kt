...
internal val baseLightPalette = FilmsColors(
...
internal val baseDarkPalette = FilmsColors(
...
val pinkLightPalette = baseLightPalette.copy(
    tintColor = Color(0xFF9C5B9B)
)

val pinkDarkPalette = baseDarkPalette.copy(
    tintColor = Color(0xFFE9ACE6)
)

val violetLightPalette = baseLightPalette.copy(
    tintColor = Color(0xFF785C92)
)

val violetDarkPalette = baseDarkPalette.copy(
    tintColor = Color(0xFFB99CE9)
)
